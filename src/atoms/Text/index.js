...
export const Heading = styled.h1`
  ...
  font-weight: ${p => (
    ...
    || p.theme.fontStyles.weights.normal
  )};
...
export const SectionHeading = styled.h3`
  ...
  font-size: ${p => p.theme.fontStyles.sizes[p.size] || p.theme.fontStyles.sizes.medium};
...
export const CardHeading = styled.h4`
  ${COMMON_STYLES}
  font-family: ${p => p.theme.fontStyles.fontFamilies.condensed};
  font-size: ${p => p.theme.fontStyles.sizes[p.size] || p.theme.fontStyles.sizes.small};
...
export const ButtonText = styled.span`
  ${COMMON_STYLES}
  font-family: ${p => p.theme.fontStyles.fontFamilies.condensed};
  font-size: ${p => p.theme.fontStyles.sizes[p.size] || p.theme.fontStyles.sizes.tiny};
...
export const QuoteText = styled.span`
  ...
  font-size: ${p => p.theme.fontStyles.sizes[p.size] || p.theme.fontStyles.sizes.medium};
  font-style: italic;
  letter-spacing: ${p => p.theme.fontStyles.letterSpacing[p.letterSpacing] || p.theme.fontStyles.letterSpacing.large};
`;
