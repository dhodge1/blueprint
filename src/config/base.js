...
const base = {
  ...
  header: {
    url:
      "https://www.foodnetwork.com/content/food-com/en.syndicated_header_combined.html?bust=true",
    preloadedStyles:
      "https://food.coreprod.fnr.sndimg.com/etc/clientlibs/assets/v2/css/food-syndicated-header-desktop.css",
  },
  sharingConstants: {
  ...
  meta: {
    ...
    descriptions: {
      ...
      classSchedule:
        "Check FNK’s live cooking class schedule frequently and never miss an interactive class with Food Network chefs and culinary experts.",
      shoppingList:
        "Create shopping lists from your favorite Food Network recipes and get your ingredients delivered.",
...
base.endpoints.baseUrl = (graphql = true) =>
  `https://${graphql ? base.endpoints.graphQLHost : base.endpoints.restHost}`;
